...
function ProfileScreen({ cart, liked }: { cart: number[]; liked: number[] }) {
  ...
  return (
    <div className="flex-1 overflow-y-auto pb-28">
      ...
      {/* Logout */}
      <div className="px-5">
        <button className="w-full py-3.5 rounded-2xl font-bold text-sm transition-transform active:scale-95 flex items-center justify-center gap-2" style={{ background: "hsla(0,80%,55%,0.12)", color: "hsl(0,80%,65%)" }}>
